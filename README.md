<h1 id="queues" align="center">management</h1>
<div align="center">
...
<div align="center">
    A library for scheduling tasks on server.
</div>
...
* you dont return anything when creating a new bucket lol 🤣
* create a table for tasks that will run no matter what
...
1. Clone this repository by running following command
	```bash
	git clone https://github.com/Cod2rDude/management
	```
2. Get the latest release of .rbxm file from [releases](../../releases)
3. Or add this as a submodule to your project
	```bash
	git submodule add https://github.com/Cod2rDude/management [PATH]
	```
